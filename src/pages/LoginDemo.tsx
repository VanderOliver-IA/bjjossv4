...
const LoginDemo = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-sans border-t-8 border-yellow-500">
      <div className="absolute top-0 w-full bg-yellow-500 text-black text-center text-xs font-bold uppercase tracking-widest py-1 z-50">
